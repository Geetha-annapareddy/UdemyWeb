...
function makesound(key){
    ...
    switch(key){
        ...
        audio2.play();
        break;
        case "s":var audio3=new Audio("./sounds/tom-1.mp3");
        audio3.play();
        break;
        case "d":var audio4=new Audio("./sounds/tom-2.mp3");
        audio4.play();
        break;
        case "j":var audio5=new Audio("./sounds/tom-3.mp3");
        audio5.play();
        break;
        case "k":var audio6=new Audio("./sounds/tom-4.mp3");
        audio6.play();
        break;
